...
namespace FinancialManagment.Web.Controllers
{
    ...
    public class IncomeCategoryController(IIncomeCategoryService incomeCategoryService) : Controller
    {
        ...
        public async Task<IActionResult> Index(PagedRequest request, CancellationToken ct)
        {
            ...
            {
                Result = await incomeCategoryService.GetAllAsync(request, ct),
                SortOptions = OptionsBuilder.GetOptionsForIncomeCategory()
            };
        ...
        public async Task<IActionResult> ChangeStatus(int id, CancellationToken ct)
        {
            ...
            TempData["Success"] = "Stav kategorie příjmu byl úspěšně změněn.";
